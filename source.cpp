...
else if (databaru < (*root)->data) tambah (&(*root)->kiri,databaru,judul2,tahun1,penulis1);
else if (databaru > (*root)->data) tambah (&(*root)->kiri,databaru,judul2,tahun1,penulis1);
...
int main(){
	...
	char judulbuku[11][20]={"Matematika Mudah","Asal Usul Surabaya","Makan Tempe"};
	int tahunbuku[11]={2000,2019,2020};
	char pnlsbuku[11][20]={"alfan","arik","putu"};
	int kode1[11]={11001,11007,11118};
